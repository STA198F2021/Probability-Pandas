...
tabglm(checkup_fit, columns = list("or", "p"),
       xvarlabels = list(region = "Region (Refrence = Midwest)", 
                         city_size = "City Size (Refrence = Large Metropolitan)",
...
checkup_fit2 <- glm(cbind(checkup_n, no_checkup_n) ~ region + 
                   ...
                   family = binomial, data = model_cities)
tabglm(checkup_fit2, columns = list("or", "p"),
       xvarlabels = list(region = "Region (Refrence = Midwest)", 
                         city_size = "City Size (Refrence = Large Metropolitan)",
                         health_access = "Health Access"),
                         factor.compression = 2)
...
```{r model validation, render=lemon_print}
