...
# colon_fit <- logistic_reg() %>%
#   set_engine("glm") %>%
#   fit(as.factor(colon_n_screened) ~ region + city_size + health_access, 
#       data=cities, family="binomial", exponentiate = TRUE)
# result1 <- tidy(colon_fit, conf.int=TRUE)
# print(result1)
