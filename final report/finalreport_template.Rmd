...
kable(tidy.cor3.final)

# kable.tidy.cor3 <- kable(tidy.cor3)
# remove_column(kable.tidy.cor3, c(2,4,7,8))
```
...
```{r Simple-Marginal-Relationship1, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
...
```{r Simple-Marginal-Relationship2, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(6,4)}
...
#relationship 3 is anova-- idk if that should be like this??

```{r Simple-Marginal-Relationship4, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(6,4)}
...
```{r Simple-Marginal-Relationship5, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
...
```{r Simple-Marginal-Relationship7, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
...
```{r Simple-Marginal-Relationship8, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
...
```{r Simple-Marginal-Relationship9, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)} 
 cities1 <- cities %>%
   na.omit(city_size)
...
```{r introvis-checkup6-region, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
cities2 <- cities %>%
  filter( region != "NA")
...
```{r introvis-checkup8-lackHC, warning=FALSE, message=FALSE, echo=FALSE, fig.dim= c(4,4)}
ggplot(cities, aes(x = health_access,
                   y= checkup,
                   color = city_size))+
  geom_point()+ 
...
# rownames(checkup_fit_df1_f) <- c("Northeast", "South", "West",
#                                  "Medium-Size Urban", "Metropolitan",
#                                  "Small-Size Urban", "HC")

checkup_fit_df1_f %>%
  # kable(row.names[2, 8] = c("Northeast", "South", "West", "Medium-Size Urban", 
  #                           "Metropolitan", "Small-Size Urban", "HC"))
