...
It includes variables such as prevalence of lack of health insurance, prevalence of checkups, and prevalence of various chronic diseases as well as various screening tests. The prevalence of lack of health insurance is a key variable as we will use this variable to observe how it affects the numbers of screenings. Having a low value of the lack of health insurance variable would indicate that a city has high prevalence of health insurance among its citizens and inversely, having a high value of the lack of health insurance variable would indicate that a city has low prevalence of health insurance among its citizens.
